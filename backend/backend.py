...
async def generate_images(code: str, api_key: str, base_url: str, image_cache: Dict[str, str]):
    # Find all images
    soup = BeautifulSoup(code, "html.parser")
    images = soup.find_all("img")
...
'''
    ...
    if response.status_code == 200:
        try:
            ...
            image_url = asyncio.run(generate_image(website_description, api_key, "https://api.openai.com/v1"))
            ...
            generated_content = asyncio.run(generate_images(content, api_key, "https://api.openai.com/v1", {}))
